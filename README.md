...
- **Berlin** the model of German capital also has mesh available  [:house:] [:bricks:] [:two:]
...
- **New York City** Department of Information Technology and Telecommunications (DOITT) [:house:] [:one:] [:two:] [:1234:]
...
- **New York City** TUM [:house:] [:car:] [:one:] [:two:] [:1234:] 
