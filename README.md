...
[:mount_fuji:] [:🏠:] [:bricks:] [:one:] [:two:] [:1234:] 
...
[:🏠:][:car:] [:evergreen_tree:] [:mount_fuji:] [:vertical_traffic_light:] [:bricks:] [:one:] [:two:] [:three:] [:1234:]
...
[🏠] [:hourglass_flowing_sand:] [:bricks:] [:one:] [:two:] 
...
[🏠][:bricks:][:two:] [:hourglass_flowing_sand:]
...
[🏠]  [:car:] [:evergreen_tree:] [:mount_fuji:] [:one:] [:two:]
...
[🏠] [:mount_fuji:] [:car:]  [:evergreen_tree:] [:one:]
...
[🏠] [:evergreen_tree:] [:mount_fuji:] [:vertical_traffic_light:] [:bricks:] [:one:] [:two:] [:three:]
